...
public class testECBmode{
	...
	public void main(int[] key, String filetype, String filename) throws IOException{
		...
		FileOutputStream imgOut = new FileOutputStream("image\\ECBencrypt" + filetype);
		...
		DataInputStream dataIn1 = new DataInputStream(new FileInputStream("image\\ECBencrypt" + filetype));
		DataOutputStream dataOut1 = new DataOutputStream(new FileOutputStream("image\\ECBdecrypt" + filetype));
